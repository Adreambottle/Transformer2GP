...
def main(num_epoch=10, save_epoch=2, logging_step=10, file_num=10, train_size=150, test_size=30):
    ...
    for j in range(num_epoch):
        ...
        for i in range(file_num):
            ...
            training_loader = DataLoader(train_dataset, **train_params, sampler=train_sampler)
...
if __name__ == "__main__":
    ...
    # 正式的
    main(num_epoch=100, save_epoch=1, logging_step=10, file_num=1, train_size=100, test_size=100)
