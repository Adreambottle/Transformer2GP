...
class ModuleUtilsMixin:
    ...
    def reset_memory_hooks_state(self):
        ...
        :func:`~adj_tf.modeling_utils.ModuleUtilsMixin.add_memory_hooks`).
        """
        for module in self.modules():
    ...
    def floating_point_ops(
        ...
        <https://arxiv.org/pdf/2001.08361.pdf>`__ section 2.1. Should be overridden for adj_tf with parameter
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin):
    ...
    :class:`~adj_tf.PreTrainedModel` takes care of storing the configuration of the models and handles methods
    ...
    Class attributes (overridden by derived classes):
        ...
        - **config_class** (:class:`~adj_tf.PretrainedConfig`) -- A subclass of
          :class:`~adj_tf.PretrainedConfig` to use as configuration class for this model architecture.
        - **load_tf_weights** (:obj:`Callable`) -- A python `method` for loading a TensorFlow checkpoint in a PyTorch
          model, taking as arguments:

            - **model** (:class:`~adj_tf.PreTrainedModel`) -- An instance of the model on which to load the
              TensorFlow checkpoint.
            - **config** (:class:`~adj_tf.PreTrainedConfig`) -- An instance of the configuration associated to
              the model.
    ...
    def save_pretrained(self, save_directory: Union[str, os.PathLike]):
        ...
        `:func:`~adj_tf.PreTrainedModel.from_pretrained`` class method.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> from adj_tf import BertConfig, BertModel
...
class SquadHeadOutput(ModelOutput):
    """
    Base class for outputs of question answering models using a :class:`~adj_tf.modeling_utils.SQuADHead`.
...
def prune_layer(
    ...
    Returns:
        :obj:`torch.nn.Linear` or :class:`~adj_tf.modeling_utils.Conv1D`: The pruned layer as a new layer with
