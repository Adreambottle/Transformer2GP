...
PROCESS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size * num_beams, sequence_length)`):
            ...
            Indices can be obtained using any class inheriting from :class:`~adj_tf.PretrainedTokenizer`. See
...
class BeamScorer(ABC):
    """
    Abstract base class for all beam scorers that are used for :meth:`~adj_tf.PretrainedModel.beam_search` and
    :meth:`~adj_tf.PretrainedModel.beam_sample`.
    """
...
class BeamSearchScorer(BeamScorer):
    r"""
    :class:`adj_tf.BeamScorer` implementing standard beam search decoding.
