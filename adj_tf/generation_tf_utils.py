...
class TFGenerationMixin:
    ...
    :class:`~adj_tf.TFPreTrainedModel`.
    """

    def prepare_inputs_for_generation(self, inputs, **kwargs):
        """
        Implement in subclasses of :class:`~adj_tf.TFPreTrainedModel` for custom behavior to prepare inputs in
        the generate method.
        """
    ...
    def generate(
        ...
        attribute of the same name inside the :class:`~adj_tf.PretrainedConfig` of the model. The default values
