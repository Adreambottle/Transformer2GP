...
class NotebookProgressBar:
    ...
    Args:
        ...
        leave (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            :meth:`~adj_tf.utils.notebook.NotebookProgressBar.close` method to make the bar disappear.
        parent (:class:`~adj_tf.notebook.NotebookTrainingTracker`, `optional`):
            A parent object (like :class:`~adj_tf.utils.notebook.NotebookTrainingTracker`) that spawns progress
...
class NotebookTrainingTracker(NotebookProgressBar):
    ...
    Args:
        ...
        column_names (:obj:`List[str]`, `optional`):
            ...
            :meth:`~adj_tf.utils.notebook.NotebookTrainingTracker.write_line` if not set).
    """
...
class NotebookProgressCallback(TrainerCallback):
    """
    A :class:`~adj_tf.TrainerCallback` that displays the progress of training or evaluation, optimized for
