...
class BatchEncoding(UserDict):
    """
    Holds the output of the :meth:`~adj_tf.tokenization_utils_base.PreTrainedTokenizerBase.encode_plus` and
    :meth:`~adj_tf.tokenization_utils_base.PreTrainedTokenizerBase.batch_encode` methods (tokens,
    attention_masks, etc).
    ...
    def n_sequences(self) -> Optional[int]:
        ...
        :class:`~adj_tf.BatchEncoding`. Currently can be one of :obj:`None` (unknown), :obj:`1` (a single
    ...
    def is_fast(self) -> bool:
        """
        :obj:`bool`: Indicate whether this :class:`~adj_tf.BatchEncoding` was generated from the result of a
        :class:`~adj_tf.PreTrainedTokenizerFast` or not.
        """
    ...
    def word_to_tokens(
        ...
        Token spans are returned as a :class:`~adj_tf.tokenization_utils_base.TokenSpan` with:
        ...
        Returns:
            Optional :class:`~adj_tf.tokenization_utils_base.TokenSpan` Span of tokens in the encoded sequence.
    ...
    def token_to_chars(self, batch_or_token_index: int, token_index: Optional[int] = None) -> CharSpan:
        ...
        Character spans are returned as a :class:`~adj_tf.tokenization_utils_base.CharSpan` with:
    ...
    def convert_to_tensors(
        ...
        Args:
            tensor_type (:obj:`str` or :class:`~adj_tf.tokenization_utils_base.TensorType`, `optional`):
                The type of tensors to use. If :obj:`str`, should be one of the values of the enum
                :class:`~adj_tf.tokenization_utils_base.TensorType`. If :obj:`None`, no modification is done.
    ...
    def to(self, device: Union[str, "torch.device"]) -> "BatchEncoding":
        ...
        Returns:
            :class:`~transformers.BatchEncoding`: The same instance of :class:`~adj_tf.BatchEncoding` after
            modification.
        """
...
class SpecialTokensMixin:
    """
    A mixin derived by :class:`~adj_tf.PreTrainedTokenizer` and :class:`~adj_tf.PreTrainedTokenizerFast` to
    ...
    def add_special_tokens(self, special_tokens_dict: Dict[str, Union[str, AddedToken]]) -> int:
        ...
        :class:`~adj_tf.BertTokenizer` :obj:`cls_token` is already registered to be :obj`'[CLS]'` and XLM's one
...
ENCODE_KWARGS_DOCSTRING = r"""
            ...
            padding (:obj:`bool`, :obj:`str` or :class:`~adj_tf.tokenization_utils_base.PaddingStrategy`, `optional`, defaults to :obj:`False`):
                ...
                * :obj:`False` or :obj:`'do_not_pad'` (default): No padding (i.e., can output a batch with sequences of
                  different lengths).
            truncation (:obj:`bool`, :obj:`str` or :class:`~adj_tf.tokenization_utils_base.TruncationStrategy`, `optional`, defaults to :obj:`False`):
            ...
            return_tensors (:obj:`str` or :class:`~adj_tf.tokenization_utils_base.TensorType`, `optional`):
...
ENCODE_PLUS_ADDITIONAL_KWARGS_DOCSTRING = r"""
            ...
            return_offsets_mapping (:obj:`bool`, `optional`, defaults to :obj:`False`):
                ...
                :class:`~adj_tf.PreTrainedTokenizerFast`, if using Python's tokenizer, this method will raise
        ...
        Return:
            :class:`~adj_tf.BatchEncoding`: A :class:`~adj_tf.BatchEncoding` with the following fields:
...
INIT_TOKENIZER_DOCSTRING = r"""
    Class attributes (overridden by derived classes)
        ...
        - **pretrained_init_configuration** (:obj:`Dict[str, Dict[str, Any]]`) -- A dictionary with, as keys, the
          ...
          tokenizer with the :meth:`~adj_tf.tokenization_utils_base.PreTrainedTokenizerBase.from_pretrained`
          method.
    ...
    Args:
        model_max_length (:obj:`int`, `optional`):
            ...
            loaded with :meth:`~adj_tf.tokenization_utils_base.PreTrainedTokenizerBase.from_pretrained`, this
...
class PreTrainedTokenizerBase(SpecialTokensMixin):
    """
    Base class for :class:`~adj_tf.PreTrainedTokenizer` and :class:`~adj_tf.PreTrainedTokenizerFast`.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], *init_inputs, **kwargs):
        r"""
        Instantiate a :class:`~adj_tf.tokenization_utils_base.PreTrainedTokenizerBase` (or a derived class) from
        ...
        Args:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                ...
                - A path to a `directory` containing vocabulary files required by the tokenizer, for instance saved
                  using the :meth:`~adj_tf.tokenization_utils_base.PreTrainedTokenizerBase.save_pretrained`
            ...
            use_auth_token (:obj:`str` or `bool`, `optional`):
                ...
                generated when running :obj:`adj_tf-cli login` (stored in :obj:`~/.huggingface`).
    ...
    def save_pretrained(
        ...
        :meth:`~adj_tf.tokenization_utils_base.PreTrainedTokenizer.from_pretrained` class method.

        .. Note::
            A "fast" tokenizer (instance of :class:`adj_tf.PreTrainedTokenizerFast`) saved with this method will
            not be possible to load back in a "slow" tokenizer, i.e. in a :class:`adj_tf.PreTrainedTokenizer`
            instance. It can only be loaded in a "fast" tokenizer, i.e. in a
            :class:`adj_tf.PreTrainedTokenizerFast` instance.
    ...
    def _save_pretrained(
        ...
        specific :meth:`~adj_tf.tokenization_utils_fast.PreTrainedTokenizerFast._save_pretrained`
        """
    ...
    def save_vocabulary(self, save_directory: str, filename_prefix: Optional[str] = None) -> Tuple[str]:
        ...
        :meth:`~adj_tf.PreTrainedTokenizerFast._save_pretrained` to save the whole state of the tokenizer.
    ...
    def tokenize(self, text: str, pair: Optional[str] = None, add_special_tokens: bool = False, **kwargs) -> List[str]:
        ...
        Args:
            ...
            kwargs (additional keyword arguments, `optional`):
                ...
                :meth:`~adj_tf.PreTrainedTokenizerBase.__call__`
    ...
    def pad(
        ...
        Args:
            encoded_inputs (:class:`~adj_tf.BatchEncoding`, list of :class:`~adj_tf.BatchEncoding`, :obj:`Dict[str, List[int]]`, :obj:`Dict[str, List[List[int]]` or :obj:`List[Dict[str, List[int]]]`):
                Tokenized inputs. Can represent one input (:class:`~adj_tf.BatchEncoding` or :obj:`Dict[str,
                List[int]]`) or a batch of tokenized inputs (list of :class:`~adj_tf.BatchEncoding`, `Dict[str,
                List[List[int]]]` or `List[Dict[str, List[int]]]`) so you can use this method during preprocessing as
                well as in a PyTorch Dataloader collate function.

                Instead of :obj:`List[int]` you can have tensors (numpy arrays, PyTorch tensors or TensorFlow tensors),
                see the note above for the return type.
            padding (:obj:`bool`, :obj:`str` or :class:`~adj_tf.tokenization_utils_base.PaddingStrategy`, `optional`, defaults to :obj:`True`):
    ...
    def truncate_sequences(
        ...
        Args:
            ...
            truncation_strategy (:obj:`str` or :class:`~adj_tf.tokenization_utils_base.TruncationStrategy`, `optional`, defaults to :obj:`False`):
        ...
        **kwargs,
        ...
        Arguments:
            ...
            return_tensors (:obj:`str` or :class:`~adj_tf.tokenization_utils_base.TensorType`, `optional`):
                ...
                * :obj:`'pt'`: Return PyTorch :obj:`torch.Tensor` objects.
                * :obj:`'np'`: Return Numpy :obj:`np.ndarray` objects.
            truncation (:obj:`bool`, :obj:`str` or :class:`~adj_tf.tokenization_utils_base.TruncationStrategy`, `optional`, defaults to :obj:`True`):
                Activates and controls truncation. Accepts the following values:
        ...
        Return:
            :class:`~transformers.BatchEncoding`: A :class:`~adj_tf.BatchEncoding` with the following fields:
