...
# Copied from adj_tf.models.xlm.modeling_tf_xlm.TFXLMMultiHeadAttention with XLM->Flaubert
...
# Copied from adj_tf.models.xlm.modeling_tf_xlm.TFXLMTransformerFFN
...
# Copied from adj_tf.models.xlm.modeling_tf_xlm.TFXLMPredLayer
...
class TFFlaubertWithLMHeadModelOutput(ModelOutput):
    """
    Base class for :class:`~adj_tf.TFFlaubertWithLMHeadModel` outputs.
