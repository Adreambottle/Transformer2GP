...
class FlaubertConfig(XLMConfig):
    """
    This is the configuration class to store the configuration of a :class:`~adj_tf.FlaubertModel` or a
    :class:`~adj_tf.TFFlaubertModel`. It is used to instantiate a FlauBERT model according to the specified
    ...
    Args:
        ...
        vocab_size (:obj:`int`, `optional`, defaults to 30145):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~adj_tf.FlaubertModel` or
            :class:`~adj_tf.TFFlaubertModel`.
