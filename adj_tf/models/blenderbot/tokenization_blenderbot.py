...
if TYPE_CHECKING:
    from adj_tf.pipelines.conversational import Conversation
...
class BlenderbotTokenizer(RobertaTokenizer):
    ...
    :class:`~adj_tf.Blenderbot` is nearly identical to :class:`~adj_tf.RobertaTokenizer` and runs
    ...
    Refer to superclass :class:`~adj_tf.RobertaTokenizer` for usage examples and documentation concerning
    parameters.
    """
    vocab_files_names = {
        "vocab_file": "vocab.json",
