...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartAttention with Bart->Blenderbot
...
# Copied from adj_tf.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Blenderbot
...
# Copied from adj_tf.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Blenderbot
...
BLENDERBOT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adj_tf.BlenderbotConfig`): Model configuration class with all the parameters of the model.
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    Conversation example::
        ...
        >>> from adj_tf import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration
...
BLENDERBOT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.BlenderbotTokenizer`. See
