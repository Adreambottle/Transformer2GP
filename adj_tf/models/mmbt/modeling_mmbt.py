...
MMBT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.MMBTConfig`): Model configuration class with all the parameters of the model.
...
MMBT_INPUTS_DOCSTRING = r"""
    Args:
        ...
        input_ids (``torch.LongTensor`` of shape ``(batch_size, sequence_length)``):
            ...
            :class:`~adj_tf.BertTokenizer`. See :meth:`adj_tf.PreTrainedTokenizer.encode` and
