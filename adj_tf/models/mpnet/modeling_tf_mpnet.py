...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertPooler with Bert->MPNet
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->MPNet
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertOutput with Bert->MPNet
...
MPNET_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adj_tf.MPNetConfig`): Model configuration class with all the parameters of the model.
...
MPNET_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.MPNetTokenizer`. See
