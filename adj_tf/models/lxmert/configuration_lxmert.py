...
class LxmertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adj_tf.LxmertModel` or a
    :class:`~adj_tf.TFLxmertModel`. It is used to instantiate a LXMERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adj_tf.LxmertModel` or
            :class:`~adj_tf.TFLxmertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the `token_type_ids` passed into :class:`~adj_tf.BertModel`.
