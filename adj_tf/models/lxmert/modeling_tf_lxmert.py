...
class TFLxmertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adj_tf.LxmertForPreTraining`.
...
LXMERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.LxmertConfig`): Model configuration class with all the parameters of the model.
...
LXMERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`np.ndarray` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.LxmertTokenizer`. See
        ...
        visual_feats: (:obj:`tf.Tensor` of shape :obj:՝(batch_size, num_visual_features, visual_feat_dim)՝):
            ...
            These are currently not provided by the adj_tf library.
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertPredictionHeadTransform with Bert->Lxmert
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertLMPredictionHead with Bert->Lxmert
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertMLMHead with Bert->Lxmert
