...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartAttention with Bart->MBart
...
MBART_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adj_tf.MBartConfig`): Model configuration class with all the parameters of the model.
...
MBART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from adj_tf import MBartTokenizer, TFMBartForConditionalGeneration, MBartConfig
    ...
    Mask filling example::
        ...
        >>> from adj_tf import MBartTokenizer, TFMBartForConditionalGeneration
        >>> tokenizer = MBartTokenizer.from_pretrained('facebook/mbart-large-cc25')
