...
# Copied from adj_tf.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from adj_tf.models.bart.modeling_bart.BartAttention with Bart->MBart
...
# Copied from adj_tf.models.bart.modeling_bart.BartClassificationHead with Bart->MBart
...
MBART_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.MBartConfig`):
...
MBART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from adj_tf import MBartTokenizer, MBartForConditionalGeneration, MBartConfig
    ...
    Mask filling example::
        ...
        >>> from adj_tf import MBartTokenizer, MBartForConditionalGeneration
        >>> tokenizer = MBartTokenizer.from_pretrained('facebook/mbart-large-cc25')
...
MBART_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.MBartTokenizer`. See
...
class MBartForSequenceClassification(MBartPreTrainedModel):
    ...
    # Copied from adj_tf.models.bart.modeling_bart.BartForSequenceClassification.forward
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
class MBartForQuestionAnswering(MBartPreTrainedModel):
    ...
    # Copied from adj_tf.models.bart.modeling_bart.BartForQuestionAnswering.forward
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
# Copied from adj_tf.models.bart.modeling_bart.BartDecoderWrapper with Bart->MBart
...
# Copied from adj_tf.models.bart.modeling_bart.BartForCausalLM with Bart->MBart
class MBartForCausalLM(MBartPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import MBartTokenizer, MBartForCausalLM
