...
SQUEEZEBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.SqueezeBertConfig`): Model configuration class with all the parameters of the model.
...
SQUEEZEBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.SqueezeBertTokenizer`. See
