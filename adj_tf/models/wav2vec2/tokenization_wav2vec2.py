...
class Wav2Vec2Tokenizer(PreTrainedTokenizer):
    ...
    This tokenizer inherits from :class:`~adj_tf.PreTrainedTokenizer` which contains some of the main methods.
    ...
    Args:
        ...
        return_attention_mask (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not :meth:`~adj_tf.Wav2Vec2Tokenizer.__call__` should return :obj:`attention_mask`.
        ...
        **kwargs
            Additional keyword arguments passed along to :class:`~adj_tf.PreTrainedTokenizer`
    """
