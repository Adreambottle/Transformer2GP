...
# Copied from adj_tf.models.bart.modeling_bart.BartAttention with Bart->Wav2Vec2
...
WAV_2_VEC_2_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.Wav2Vec2Config`): Model configuration class with all the parameters of the model.
...
WAV_2_VEC_2_INPUTS_DOCSTRING = r"""
    Args:
        input_values (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            soundfile`). To prepare the array into `input_values`, the :class:`~adj_tf.Wav2Vec2Tokenizer` should
            be used for padding and conversion into a tensor of type `torch.FloatTensor`. See
            :meth:`adj_tf.Wav2Vec2Tokenizer.__call__` for details.
...
class Wav2Vec2Model(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import Wav2Vec2Tokenizer, Wav2Vec2Model
...
class Wav2Vec2ForCTC(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> import torch
            >>> from adj_tf import Wav2Vec2Tokenizer, Wav2Vec2ForCTC
            >>> from datasets import load_dataset
            >>> import soundfile as sf
