...
class MT5Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adj_tf.MT5Model` or a
    :class:`~adj_tf.TFMT5Model`. It is used to instantiate a mT5 model according to the specified arguments,
    ...
    Arguments:
        vocab_size (:obj:`int`, `optional`, defaults to 32128):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adj_tf.T5Model` or :class:`~adj_tf.TFT5Model`.
