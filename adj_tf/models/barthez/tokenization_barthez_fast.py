...
class BarthezTokenizerFast(PreTrainedTokenizerFast):
    """
    Adapted from :class:`~adj_tf.CamembertTokenizer` and :class:`~adj_tf.BartTokenizer`. Construct a "fast"
    BARThez tokenizer. Based on `SentencePiece <https://github.com/google/sentencepiece>`__.

    This tokenizer inherits from :class:`~adj_tf.PreTrainedTokenizerFast` which contains most of the main
