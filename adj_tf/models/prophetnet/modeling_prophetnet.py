...
PROPHETNET_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.ProphetNetConfig`): Model configuration class with all the parameters of the model.
...
PROPHETNET_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.ProphetNetTokenizer`. See
...
class ProphetNetEncoder(ProphetNetPreTrainedModel):
    ...
    word_embeddings  (:obj:`torch.nn.Embeddings` of shape :obj:`(config.vocab_size, config.hidden_size)`, `optional`):
        The word embedding parameters. This can be used to initialize :class:`~adj_tf.ProphetNetEncoder` with
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import ProphetNetTokenizer, ProphetNetEncoder
            >>> import torch
...
class ProphetNetDecoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import ProphetNetTokenizer, ProphetNetDecoder
            >>> import torch
...
class ProphetNetModel(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import ProphetNetTokenizer, ProphetNetModel
...
class ProphetNetForConditionalGeneration(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import ProphetNetTokenizer, ProphetNetForConditionalGeneration
...
class ProphetNetForCausalLM(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import ProphetNetTokenizer, ProphetNetForCausalLM
            >>> import torch
            ...
            >>> from adj_tf import BertTokenizer, EncoderDecoderModel, ProphetNetTokenizer
            >>> import torch
...
class ProphetNetDecoderWrapper(ProphetNetPreTrainedModel):
    """
    This is a wrapper class, so that :class:`~adj_tf.ProphetNetForCausalLM` can correctly be loaded from
