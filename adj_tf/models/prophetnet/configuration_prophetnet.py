...
class ProphetNetConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adj_tf.ProphetNetModel`. It is used
    ...
    Args:
        ...
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~adj_tf.ProphetNetModel`.
