...
# Copied from adj_tf.models.bert.modeling_bert.BertSelfAttention with Bert->LayoutLM
...
# Copied from adj_tf.models.bert.modeling_bert.BertSelfOutput with Bert->LayoutLM
...
# Copied from adj_tf.models.bert.modeling_bert.BertAttention with Bert->LayoutLM
...
# Copied from adj_tf.models.bert.modeling_bert.BertIntermediate
...
# Copied from adj_tf.models.bert.modeling_bert.BertOutput with Bert->LayoutLM
...
# Copied from adj_tf.models.bert.modeling_bert.BertLayer with Bert->LayoutLM
...
# Copied from adj_tf.models.bert.modeling_bert.BertEncoder with Bert->LayoutLM
...
# Copied from adj_tf.models.bert.modeling_bert.BertPooler
...
# Copied from adj_tf.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->LayoutLM
...
# Copied from adj_tf.models.bert.modeling_bert.BertLMPredictionHead with Bert->LayoutLM
...
# Copied from adj_tf.models.bert.modeling_bert.BertOnlyMLMHead with Bert->LayoutLM
...
LAYOUTLM_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.LayoutLMConfig`): Model configuration class with all the parameters of the model.
...
LAYOUTLM_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`adj_tf.LayoutLMTokenizer`. See
        ...
        return_dict (:obj:`bool`, `optional`):
            If set to ``True``, the model will return a :class:`~adj_tf.file_utils.ModelOutput` instead of a
            plain tuple.
"""
...
class LayoutLMModel(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import LayoutLMTokenizer, LayoutLMModel
            >>> import torch
...
class LayoutLMForMaskedLM(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import LayoutLMTokenizer, LayoutLMForMaskedLM
            >>> import torch
...
class LayoutLMForSequenceClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import LayoutLMTokenizer, LayoutLMForSequenceClassification
            >>> import torch
...
class LayoutLMForTokenClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import LayoutLMTokenizer, LayoutLMForTokenClassification
            >>> import torch
