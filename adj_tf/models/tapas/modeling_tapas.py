...
class TableQuestionAnsweringOutput(ModelOutput):
    """
    Output type of :class:`~adj_tf.TapasForQuestionAnswering`.
...
# Copied from adj_tf.models.bert.modeling_bert.BertSelfOutput
...
# Copied from adj_tf.models.bert.modeling_bert.BertAttention with Bert->Tapas
...
# Copied from adj_tf.models.bert.modeling_bert.BertOutput
...
# Copied from adj_tf.models.bert.modeling_bert.BertLayer with Bert->Tapas
...
class TapasPreTrainedModel(PreTrainedModel):
    ...
    # Copied from adj_tf.models.bert.modeling_bert.BertPreTrainedModel._init_weights
...
TAPAS_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.TapasConfig`): Model configuration class with all the parameters of the model.
...
TAPAS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            :class:`~adj_tf.TapasTokenizer`. See :meth:`adj_tf.PreTrainedTokenizer.encode` and
            :meth:`adj_tf.PreTrainedTokenizer.__call__` for details.
        ...
        token_type_ids (:obj:`torch.LongTensor` of shape :obj:`({0}, 7)`, `optional`):
            ...
            :class:`~adj_tf.TapasTokenizer`. See this class for more info.

            `What are token type IDs? <../glossary.html#token-type-ids>`_
        position_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`, `optional`):
            Indices of positions of each input sequence tokens in the position embeddings. If
            ``reset_position_index_per_cell`` of :class:`~adj_tf.TapasConfig` is set to ``True``, relative
...
class TapasModel(TapasPreTrainedModel):
    """
    This class is a small change compared to :class:`~adj_tf.BertModel`, taking into account the additional token
    type ids.
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import TapasTokenizer, TapasModel
            >>> import pandas as pd
    ...
    def forward(
        ...
        **kwargs
        ...
        Examples::
            ...
            >>> from adj_tf import TapasTokenizer, TapasForMaskedLM
            >>> import pandas as pd
...
class TapasForQuestionAnswering(TapasPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import TapasTokenizer, TapasForQuestionAnswering
            >>> import pandas as pd
...
class TapasForSequenceClassification(TapasPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import TapasTokenizer, TapasForSequenceClassification
            >>> import torch
            >>> import pandas as pd
