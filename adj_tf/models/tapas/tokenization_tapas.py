...
class TapasTruncationStrategy(ExplicitEnum):
    """
    Possible values for the ``truncation`` argument in :meth:`~adj_tf.TapasTokenizer.__call__`. Useful for
...
TAPAS_ENCODE_PLUS_ADDITIONAL_KWARGS_DOCSTRING = r"""
            ...
            padding (:obj:`bool`, :obj:`str` or :class:`~adj_tf.tokenization_utils_base.PaddingStrategy`, `optional`, defaults to :obj:`False`):
                ...
                * :obj:`False` or :obj:`'do_not_pad'` (default): No padding (i.e., can output a batch with sequences of
                  different lengths).
            truncation (:obj:`bool`, :obj:`str` or :class:`~adj_tf.TapasTruncationStrategy`, `optional`, defaults to :obj:`False`):
...
class TapasTokenizer(PreTrainedTokenizer):
    ...
    This tokenizer inherits from :class:`~adj_tf.PreTrainedTokenizer` which contains most of the main methods.
    Users should refer to this superclass for more information regarding those methods.
    :class:`~adj_tf.TapasTokenizer` creates several token type ids to encode tabular structure. To be more
    ...
    :class:`~adj_tf.TapasTokenizer` runs end-to-end tokenization on a table and associated sentences: punctuation
        ...
        **kwargs
        ...
        if return_offsets_mapping:
            raise NotImplementedError(
                ...
                "adj_tf.PreTrainedTokenizerFast."
            )
    ...
    def _get_truncated_table_rows(
        ...
        Args:
            ...
            truncation_strategy (:obj:`str` or :obj:`~adj_tf.TapasTruncationStrategy`):
    ...
    def convert_logits_to_predictions(self, data, logits, logits_agg=None, cell_classification_threshold=0.5):
        """
        Converts logits of :class:`~adj_tf.TapasForQuestionAnswering` to actual predicted answer coordinates and
...
# Copied from adj_tf.models.bert.tokenization_bert.BasicTokenizer
...
# Copied from adj_tf.models.bert.tokenization_bert.WordpieceTokenizer
