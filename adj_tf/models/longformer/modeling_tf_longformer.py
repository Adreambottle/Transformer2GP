...
# Copied from adj_tf.models.roberta.modeling_tf_roberta.TFRobertaLMHead with Roberta->Longformer
...
# Copied from adj_tf.models.roberta.modeling_tf_roberta.TFRobertaEmbeddings with Roberta->Longformer
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Longformer
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertOutput with Bert->Longformer
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertPooler with Bert->Longformer
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->Longformer
...
LONGFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.LongformerConfig`): Model configuration class with all the parameters of the model.
...
LONGFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.LongformerTokenizer`. See
...
class TFLongformerModel(TFLongformerPreTrainedModel):
    ...
    This class copies code from :class:`~adj_tf.TFRobertaModel` and overwrites standard self-attention with
