...
ENCODER_DECODER_START_DOCSTRING = r"""
    ...
    :meth:`~adj_tf.AutoModel.from_pretrained` function and the decoder is loaded via
    :meth:`~adj_tf.AutoModelForCausalLM.from_pretrained` function. Cross-attention layers are automatically added
    ...
    Parameters:
        config (:class:`~adj_tf.T5Config`): Model configuration class with all the parameters of the model.
...
ENCODER_DECODER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.PreTrainedTokenizer`. See
        ...
        decoder_input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            :class:`~adj_tf.PretrainedTokenizer`. See :meth:`adj_tf.PreTrainedTokenizer.encode` and
        ...
        return_dict (:obj:`bool`, `optional`):
            If set to ``True``, the model will return a :class:`~adj_tf.file_utils.Seq2SeqLMOutput` instead of a
            plain tuple.
...
class EncoderDecoderModel(PreTrainedModel):
    r"""
    :class:`~adj_tf.EncoderDecoder` is a generic model class that will be instantiated as a transformer
    architecture with one of the base model classes of the library as encoder and another one as decoder when created
    with the :meth`~adj_tf.AutoModel.from_pretrained` class method for the encoder and
    :meth`~adj_tf.AutoModelForCausalLM.from_pretrained` class method for the decoder.
    """
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        Example::
            ...
            >>> from adj_tf import EncoderDecoderModel
    ...
    def forward(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from adj_tf import EncoderDecoderModel, BertTokenizer
            >>> import torch
