...
class TFMobileBertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adj_tf.TFMobileBertForPreTraining`.
...
MOBILEBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.MobileBertConfig`): Model configuration class with all the parameters of the model.
...
MOBILEBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.MobileBertTokenizer`. See
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from adj_tf import MobileBertTokenizer, TFMobileBertForPreTraining
...
class TFMobileBertForNextSentencePrediction(TFMobileBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from adj_tf import MobileBertTokenizer, TFMobileBertForNextSentencePrediction
    ...
    # Copied from adj_tf.models.bert.modeling_tf_bert.TFBertForNextSentencePrediction.serving_output
