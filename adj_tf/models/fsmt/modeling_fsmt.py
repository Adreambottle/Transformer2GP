...
# - beam search: stops as soon as num_beams == len(hypos) (whereas adj_tf
#   is not satisfied there and will continue searching until the next cycles
#   aren't promising something better), comparing BLEU scores - the adj_tf
...
FSMT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.FSMTConfig`): Model configuration class with all the parameters of the model.
...
FSMT_GENERATION_EXAMPLE = r"""
    Translation example::
        ...
        from adj_tf import FSMTTokenizer, FSMTForConditionalGeneration
...
FSMT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            IIndices can be obtained using :class:`~adj_tf.FSTMTokenizer`. See
