...
# Copied from adj_tf.models.bart.modeling_tf_bart.shift_tokens_right
...
# Copied from adj_tf.models.bart.modeling_tf_bart._make_causal_mask
...
# Copied from adj_tf.models.bart.modeling_tf_bart._expand_mask
...
# Copied from adj_tf.models.blenderbot.modeling_tf_blenderbot.TFBlenderbotLearnedPositionalEmbedding with Blenderbot->BlenderbotSmall
...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartAttention with Bart->BlenderbotSmall
...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartEncoderLayer with Bart->BlenderbotSmall
...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartDecoderLayer with Bart->BlenderbotSmall
...
class TFBlenderbotSmallPreTrainedModel(TFPreTrainedModel):
    ...
    # Copied from adj_tf.models.bart.modeling_tf_bart.TFBartPretrainedModel.serving
...
BLENDERBOT_SMALL_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adj_tf.BlenderbotSmallConfig`): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the
            configuration. Check out the :meth:`~adj_tf.TFPreTrainedModel.from_pretrained` method to load the
            model weights.
"""
...
BLENDERBOT_SMALL_GENERATION_EXAMPLE = r"""
    Conversation example::
        ...
        >>> from adj_tf import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration
...
BLENDERBOT_SMALL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.BlenderbotSmallTokenizer`. See
        ...
        **kwargs,
        ...
        Args:
            input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~adj_tf.BlenderbotSmallTokenizer`. See
                :meth:`adj_tf.PreTrainedTokenizer.encode` and :meth:`adj_tf.PreTrainedTokenizer.__call__`
                for details.
...
class TFBlenderbotSmallModel(TFBlenderbotSmallPreTrainedModel):
    ...
    # Copied from adj_tf.models.bart.modeling_tf_bart.TFBartModel.serving_output
...
class TFBlenderbotSmallForConditionalGeneration(TFBlenderbotSmallPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    # Copied from adj_tf.models.bart.modeling_tf_bart.TFBartForConditionalGeneration.serving_output
    def serving_output(self, output):
        pkv = tf.tuple(output.past_key_values)[1] if self.config.use_cache else None
        dec_hs = tf.convert_to_tensor(output.decoder_hidden_states) if self.config.output_hidden_states else None
        dec_attns = tf.convert_to_tensor(output.decoder_attentions) if self.config.output_attentions else None
    ...
    # Copied from adj_tf.models.bart.modeling_tf_bart.TFBartForConditionalGeneration.prepare_inputs_for_generation
    ...
    @staticmethod
    # Copied from adj_tf.models.bart.modeling_tf_bart.TFBartForConditionalGeneration._reorder_cache
