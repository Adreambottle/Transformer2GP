...
# Copied from adj_tf.models.albert.modeling_tf_albert.TFAlbertEmbeddings with Albert->ConvBert
...
CONVBERT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adj_tf.ConvBertConfig`): Model configuration class with all the parameters of the model.
...
CONVBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.ConvBertTokenizer`. See
