...
class TFFunnelForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adj_tf.FunnelForPreTraining`.
...
FUNNEL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.XxxConfig`): Model configuration class with all the parameters of the model.
...
FUNNEL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.FunnelTokenizer`. See
    ...
    def call(
        ...
        **kwargs
        ...
        Examples::
            ...
            >>> from adj_tf import FunnelTokenizer, TFFunnelForPreTraining
            >>> import torch
