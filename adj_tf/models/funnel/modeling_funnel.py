...
FUNNEL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.FunnelConfig`): Model configuration class with all the parameters of the model.
...
class FunnelForPreTraining(FunnelPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import FunnelTokenizer, FunnelForPreTraining
            >>> import torch
