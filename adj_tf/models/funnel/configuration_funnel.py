...
class FunnelConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adj_tf.FunnelModel` or a
    :class:`~adj_tf.TFBertModel`. It is used to instantiate a Funnel Transformer model according to the specified
    ...
    Configuration objects inherit from :class:`~adj_tf.PretrainedConfig` and can be used to control the model
    outputs. Read the documentation from :class:`~adj_tf.PretrainedConfig` for more information.

    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            Vocabulary size of the Funnel transformer. Defines the number of different tokens that can be represented
            by the :obj:`inputs_ids` passed when calling :class:`~adj_tf.FunnelModel` or
            :class:`~adj_tf.TFFunnelModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 3):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~adj_tf.FunnelModel` or
            :class:`~adj_tf.TFFunnelModel`.
