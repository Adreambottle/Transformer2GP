...
from ..bert.modeling_bert_old import BertEncoder
...
BERT_GENERATION_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.BertGenerationConfig`): Model configuration class with all the parameters of the model.
...
BERT_GENERATION_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.BertGenerationTokenizer`. See
...
class BertGenerationEncoder(BertGenerationPreTrainedModel):
    ...
    :class:`~adj_tf.EncoderDecoderModel` class as described in `Leveraging Pre-trained Checkpoints for Sequence
...
class BertGenerationDecoder(BertGenerationPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import BertGenerationTokenizer, BertGenerationDecoder, BertGenerationConfig
            >>> import torch
