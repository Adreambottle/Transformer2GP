...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertSelfAttention with Bert->Electra
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->Electra
...
# Copied from from adj_tf.models.bert.modeling_tf_bert.TFBertAttention with Bert->Electra
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Electra
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertOutput with Bert->Electra
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertLayer with Bert->Electra
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertEncoder with Bert->Electra
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertPooler with Bert->Electra
...
# Copied from adj_tf.models.albert.modeling_tf_albert.TFAlbertEmbeddings with Albert->Electra
...
class TFElectraForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adj_tf.TFElectraForPreTraining`.
...
ELECTRA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.ElectraConfig`): Model configuration class with all the parameters of the model.
...
ELECTRA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.ElectraTokenizer`. See
...
class TFElectraModel(TFElectraPreTrainedModel):
    ...
    # Copied from adj_tf.models.distilbert.modeling_tf_distilbert.TFDistilBertModel.serving_output
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from adj_tf import ElectraTokenizer, TFElectraForPreTraining
