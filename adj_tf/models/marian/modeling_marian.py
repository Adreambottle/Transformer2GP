...
# Copied from adj_tf.models.bart.modeling_bart.BartAttention with Bart->Marian
...
# Copied from adj_tf.models.bart.modeling_bart.BartEncoderLayer with Bart->Marian
...
# Copied from adj_tf.models.bart.modeling_bart.BartDecoderLayer with Bart->Marian
...
MARIAN_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.MarianConfig`):
...
MARIAN_GENERATION_EXAMPLE = r"""
        ...
        Examples::
            ...
            >>> from adj_tf import MarianTokenizer, MarianMTModel
...
class MarianModel(MarianPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import MarianTokenizer, MarianModel
...
# Copied from adj_tf.models.bart.modeling_bart.BartDecoderWrapper with Bart->Marian
...
# Copied from adj_tf.models.bart.modeling_bart.BartForCausalLM with Bart->Marian
class MarianForCausalLM(MarianPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import MarianTokenizer, MarianForCausalLM
