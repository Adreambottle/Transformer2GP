...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartAttention with Bart->Marian
...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartEncoderLayer with Bart->Marian
...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartDecoderLayer with Bart->Marian
...
MARIAN_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adj_tf.MarianConfig`): Model configuration class with all the parameters of the model.
...
MARIAN_GENERATION_EXAMPLE = r"""
        ...
        Examples::
            ...
            >>> from adj_tf import MarianTokenizer, TFMarianMTModel
...
MARIAN_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.MarianTokenizer`. See
