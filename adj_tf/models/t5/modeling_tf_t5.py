...
T5_ENCODER_INPUTS_DOCSTRING = r"""
    Args:
        inputs (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.T5Tokenizer`. See
            :func:`adj_tf.PreTrainedTokenizer.__call__` and :func:`adj_tf.PreTrainedTokenizer.encode` for
            details.
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from adj_tf import T5Tokenizer, TFT5Model
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from adj_tf import T5Tokenizer, TFT5ForConditionalGeneration
