...
class T5Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adj_tf.T5Model` or a
    :class:`~adj_tf.TFT5Model`. It is used to instantiate a T5 model according to the specified arguments,
