...
# Copied from adj_tf.models.marian.modeling_tf_marian.TFMarianSinusoidalPositionalEmbedding with Marian->Pegasus
...
# Copied from adj_tf.models.bart.modeling_tf_bart.TFBartAttention with Bart->Pegasus
...
# Copied from adj_tf.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Pegasus
...
# Copied from adj_tf.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Pegasus
...
PEGASUS_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adj_tf.PegasusConfig`): Model configuration class with all the parameters of the model.
...
PEGASUS_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from adj_tf import PegasusTokenizer, TFPegasusForConditionalGeneration
...
PEGASUS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.PegasusTokenizer`. See
