...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertPooler with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertSelfAttention with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertAttention with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertOutput with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertLayer with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_tf_bert.TFBertEncoder with Bert->Roberta
...
class TFRobertaMainLayer(tf.keras.layers.Layer):
    ...
    # Copied from adj_tf.models.bert.modeling_tf_bert.TFBertMainLayer.get_input_embeddings
    def get_input_embeddings(self) -> tf.keras.layers.Layer:
        return self.embeddings

    # Copied from adj_tf.models.bert.modeling_tf_bert.TFBertMainLayer.set_input_embeddings
    def set_input_embeddings(self, value: tf.Variable):
        self.embeddings.weight = value
        self.embeddings.vocab_size = shape_list(value)[0]

    # Copied from adj_tf.models.bert.modeling_tf_bert.TFBertMainLayer._prune_heads
    ...
    # Copied from adj_tf.models.bert.modeling_tf_bert.TFBertMainLayer.call
    def call(
        self,
...
ROBERTA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.RobertaTokenizer`. See
