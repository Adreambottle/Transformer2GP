...
ROBERTA_START_DOCSTRING = r"""
    ...
    This model inherits from :class:`~adj_tf.FlaxPreTrainedModel`. Check the superclass documentation for the
    ...
    Parameters:
        config (:class:`~adj_tf.RobertaConfig`): Model configuration class with all the parameters of the
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertLayerNorm with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertEmbedding with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertEmbeddings with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertAttention with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertIntermediate with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertOutput with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertLayerCollection with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertEncoder with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertPooler with Bert->Roberta
...
# Copied from adj_tf.models.bert.modeling_flax_bert.FlaxBertModule with Bert->Roberta
