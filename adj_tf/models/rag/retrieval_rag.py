...
class Index:
    """
    A base class for the Indices encapsulated by the :class:`~adj_tf.RagRetriever`.
    """
...
class RagRetriever:
    ...
    Examples::
        ...
        >>> from adj_tf import RagRetriever
    ...
    def __call__(
        ...
        Args:
            ...
            n_docs (:obj:`int`, `optional`):
                The number of docs retrieved per query.
            return_tensors (:obj:`str` or :class:`~adj_tf.tokenization_utils_base.TensorType`, `optional`, defaults to "pt"):
        ...
        Returns: :class:`~adj_tf.BatchEncoding`: A :class:`~adj_tf.BatchEncoding` with the following
        fields:
