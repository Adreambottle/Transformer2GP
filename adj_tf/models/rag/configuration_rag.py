...
RAG_CONFIG_DOC = r"""
    :class:`~adj_tf.RagConfig` stores the configuration of a `RagModel`. Configuration objects inherit from
    :class:`~adj_tf.PretrainedConfig` and can be used to control the model outputs. Read the documentation from
    :class:`~adj_tf.PretrainedConfig` for more information.
    ...
    Args:
        ...
        max_combined_length (:obj:`int`, `optional`, defaults to 300):
            Max length of contextualized input returned by :meth:`~adj_tf.RagRetriever.__call__`.
        retrieval_vector_size (:obj:`int`, `optional`, defaults to 768):
            Dimensionality of the document embeddings indexed by :class:`~adj_tf.RagRetriever`.
        ...
        passages_path: (:obj:`str`, `optional`):
            ...
            :class:`~adj_tf.models.rag.retrieval_rag.LegacyIndex`
...
class RagConfig(PretrainedConfig):
    ...
    def from_question_encoder_generator_configs(
        ...
        r"""
        Instantiate a :class:`~adj_tf.EncoderDecoderConfig` (or a derived class) from a pre-trained encoder model
    ...
    def to_dict(self):
        ...
        :meth:`~adj_tf.PretrainedConfig.to_dict`.
