...
class XSoftmax(torch.autograd.Function):
    ...
    Example::
          ...
          >>> import torch
          >>> from adj_tf.models.deberta.modeling_deberta import XSoftmax
...
# Copied from adj_tf.models.bert.modeling_bert.BertIntermediate with Bert->Deberta
...
class DisentangledSelfAttention(torch.nn.Module):
    ...
    Parameters:
        config (:obj:`str`):
            ...
            `BertConfig`, for more details, please refer :class:`~adj_tf.DebertaConfig`
...
DEBERTA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.DebertaConfig`): Model configuration class with all the parameters of the model.
...
DEBERTA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`{0}`):
            ...
            Indices can be obtained using :class:`adj_tf.DebertaTokenizer`. See
