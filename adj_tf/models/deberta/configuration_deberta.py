...
class DebertaConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adj_tf.DebertaModel` or a
    :class:`~adj_tf.TFDebertaModel`. It is used to instantiate a DeBERTa model according to the specified
    ...
    Arguments:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adj_tf.DebertaModel` or
            :class:`~adj_tf.TFDebertaModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~adj_tf.DebertaModel` or
            :class:`~adj_tf.TFDebertaModel`.
