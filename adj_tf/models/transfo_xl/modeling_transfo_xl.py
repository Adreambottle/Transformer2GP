...
TRANSFO_XL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.TransfoXLConfig`): Model configuration class with all the parameters of the model.
...
TRANSFO_XL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.TransfoXLTokenizer`. See
...
@add_start_docstrings(
    ...
    :class:`~adj_tf.TransfoXLForSequenceClassification` uses the last token in order to do the classification, as
