...
RETRIBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.RetriBertConfig`): Model configuration class with all the parameters of the model.
    ...
    def forward(
        ...
        Args:
            input_ids_query (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~adj_tf.RetriBertTokenizer`. See
