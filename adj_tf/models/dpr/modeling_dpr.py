...
from ..bert.modeling_bert_old import BertModel
...
class DPRContextEncoderOutput(ModelOutput):
    """
    Class for outputs of :class:`~adj_tf.DPRQuestionEncoder`.
...
class DPRContextEncoder(DPRPretrainedContextEncoder):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import DPRContextEncoder, DPRContextEncoderTokenizer
...
class DPRQuestionEncoder(DPRPretrainedQuestionEncoder):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import DPRQuestionEncoder, DPRQuestionEncoderTokenizer
