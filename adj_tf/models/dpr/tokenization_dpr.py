...
class DPRContextEncoderTokenizer(BertTokenizer):
    ...
    :class:`~adj_tf.DPRContextEncoderTokenizer` is identical to :class:`~adj_tf.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~adj_tf.BertTokenizer` for usage examples and documentation concerning
    parameters.
    """
...
class DPRQuestionEncoderTokenizer(BertTokenizer):
    ...
    :class:`~adj_tf.DPRQuestionEncoderTokenizer` is identical to :class:`~adj_tf.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece.
...
class DPRReaderTokenizer(CustomDPRReaderTokenizerMixin, BertTokenizer):
    ...
    :class:`~adj_tf.DPRReaderTokenizer` is almost identical to :class:`~adj_tf.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece. The difference is that is has three inputs strings:
    question, titles and texts that are combined to be fed to the :class:`~adj_tf.DPRReader` model.
