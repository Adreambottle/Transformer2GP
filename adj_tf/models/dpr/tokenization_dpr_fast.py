...
class DPRContextEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~adj_tf.DPRContextEncoderTokenizerFast` is identical to :class:`~adj_tf.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~adj_tf.BertTokenizerFast` for usage examples and documentation concerning
    parameters.
    """
...
class DPRQuestionEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~adj_tf.DPRQuestionEncoderTokenizerFast` is identical to :class:`~adj_tf.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.
...
class CustomDPRReaderTokenizerMixin:
    ...
    def decode_best_spans(
        ...
        Examples::
            ...
            >>> from adj_tf import DPRReader, DPRReaderTokenizer
...
class DPRReaderTokenizerFast(CustomDPRReaderTokenizerMixin, BertTokenizerFast):
    ...
    :class:`~adj_tf.DPRReaderTokenizerFast` is almost identical to :class:`~adj_tf.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece. The difference is that is has three inputs
    strings: question, titles and texts that are combined to be fed to the :class:`~adj_tf.DPRReader` model.
