...
class TFDPRContextEncoderOutput(ModelOutput):
    r"""
    Class for outputs of :class:`~adj_tf.TFDPRContextEncoder`.
...
class TFDPRQuestionEncoderOutput(ModelOutput):
    """
    Class for outputs of :class:`~adj_tf.TFDPRQuestionEncoder`.
...
class TFDPRReaderOutput(ModelOutput):
    """
    Class for outputs of :class:`~adj_tf.TFDPRReaderEncoder`.
...
TF_DPR_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.DPRConfig`): Model configuration class with all the parameters of the model.
...
TF_DPR_ENCODERS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.DPRTokenizer`. See
...
TF_DPR_READER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids: (:obj:`Numpy array` or :obj:`tf.Tensor` of shapes :obj:`(n_passages, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.DPRReaderTokenizer`. See this class documentation for
            more details.
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from adj_tf import TFDPRContextEncoder, DPRContextEncoderTokenizer
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from adj_tf import TFDPRQuestionEncoder, DPRQuestionEncoderTokenizer
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from adj_tf import TFDPRReader, DPRReaderTokenizer
