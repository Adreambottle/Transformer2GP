...
class AlbertAttention(nn.Module):
    ...
    # Copied from adj_tf.models.bert.modeling_bert.BertSelfAttention.transpose_for_scores
...
class AlbertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adj_tf.AlbertForPreTraining`.
...
class AlbertForPreTraining(AlbertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import AlbertTokenizer, AlbertForPreTraining
            >>> import torch
