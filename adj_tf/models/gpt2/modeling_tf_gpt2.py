    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from adj_tf import GPT2Tokenizer, TFGPT2DoubleHeadsModel
...
@add_start_docstrings(
    ...
    :class:`~adj_tf.TFGPT2ForSequenceClassification` uses the last token in order to do the classification, as
