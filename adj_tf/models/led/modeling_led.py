...
# Copied from adj_tf.models.longformer.modeling_longformer.LongformerSelfAttention with Longformer->LEDEncoder
...
@dataclass
# Copied from adj_tf.models.longformer.modeling_longformer.LongformerBaseModelOutput with Longformer->LEDEncoder
...
LED_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from adj_tf import LEDTokenizer, LEDForConditionalGeneration, LEDConfig
...
class LEDForConditionalGeneration(LEDPreTrainedModel):
    ...
    def forward(
        ...
        Conditional generation example::
            ...
            >>> from adj_tf import LEDTokenizer, LEDForConditionalGeneration
            >>> tokenizer = LEDTokenizer.from_pretrained('allenai/led-base-16384')
