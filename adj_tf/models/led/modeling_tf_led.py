...
# Copied from adj_tf.models.longformer.modeling_tf_longformer.TFLongformerSelfAttention with TFLongformer->TFLEDEncoder
...
@dataclass
# Copied from adj_tf.models.longformer.modeling_tf_longformer.TFLongformerBaseModelOutput with TFLongformer->TFLEDEncoder
...
LED_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adj_tf.LEDConfig`): Model configuration class with all the parameters of the model.
        ...
        **kwargs,
        ...
        Args:
            input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~adj_tf.LEDTokenizer`. See
    ...
    def call(
        ...
        **kwargs,
        ...
        Args:
            input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
                provide it. Indices can be obtained using :class:`~adj_tf.LEDTokenizer`. See
                :meth:`adj_tf.PreTrainedTokenizer.encode` and :meth:`adj_tf.PreTrainedTokenizer.__call__`
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from adj_tf import LEDTokenizer, TFLEDForConditionalGeneration
            >>> import tensorflow as tf
