...
DISTILBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.DistilBertConfig`): Model configuration class with all the parameters of the model.
...
DISTILBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adj_tf.DistilBertTokenizer`. See
...
class DistilBertForMultipleChoice(DistilBertPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import DistilBertTokenizer, DistilBertForMultipleChoice
            >>> import torch
