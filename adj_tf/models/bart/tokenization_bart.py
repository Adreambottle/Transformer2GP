...
class BartTokenizer(RobertaTokenizer):
    ...
    :class:`~adj_tf.BartTokenizer` is identical to :class:`~adj_tf.RobertaTokenizer`. Refer to superclass
    :class:`~adj_tf.RobertaTokenizer` for usage examples and documentation concerning the initialization
