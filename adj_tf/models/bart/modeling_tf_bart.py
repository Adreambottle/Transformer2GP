...
BART_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adj_tf.BartConfig`): Model configuration class with all the parameters of the model.
...
BART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from adj_tf import BartTokenizer, TFBartForConditionalGeneration, BartConfig
    ...
    Mask filling example::
        ...
        >>> from adj_tf import BartTokenizer, TFBartForConditionalGeneration
        >>> tokenizer = BartTokenizer.from_pretrained('facebook/bart-large')
...
BART_INPUTS_DOCSTRING = r"""
    Args:
        ...
        decoder_input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            Indices can be obtained using :class:`~adj_tf.BartTokenizer`. See
            :meth:`adj_tf.PreTrainedTokenizer.encode` and :meth:`adj_tf.PreTrainedTokenizer.__call__` for
            details.
