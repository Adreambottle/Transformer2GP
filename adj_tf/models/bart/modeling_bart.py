...
BART_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.BartConfig`):
...
BART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from adj_tf import BartTokenizer, BartForConditionalGeneration, BartConfig
    ...
    Mask filling example::
        ...
        >>> from adj_tf import BartTokenizer, BartForConditionalGeneration
        >>> tokenizer = BartTokenizer.from_pretrained('facebook/bart-large')
...
class BartForCausalLM(BartPretrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adj_tf import BartTokenizer, BartForCausalLM
