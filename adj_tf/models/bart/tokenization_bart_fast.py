...
class BartTokenizerFast(RobertaTokenizerFast):
    ...
    :class:`~adj_tf.BartTokenizerFast` is identical to :class:`~adj_tf.RobertaTokenizerFast`. Refer to
    superclass :class:`~adj_tf.RobertaTokenizerFast` for usage examples and documentation concerning the
