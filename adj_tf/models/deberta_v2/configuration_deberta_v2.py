...
class DebertaV2Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adj_tf.DebertaV2Model`. It is used
    ...
    Arguments:
        vocab_size (:obj:`int`, `optional`, defaults to 128100):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~adj_tf.DebertaV2Model`.
