...
OPENAI_GPT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.OpenAIGPTConfig`): Model configuration class with all the parameters of the model.
...
OPENAI_GPT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.OpenAIGPTTokenizer`. See
...
class TFOpenAIGPTLMHeadModel(TFOpenAIGPTPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    # Copied from adj_tf.models.bert.modeling_tf_bert.TFBertLMHeadModel.serving_output
    ...
    def call(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> import tensorflow as tf
            >>> from adj_tf import OpenAIGPTTokenizer, TFOpenAIGPTDoubleHeadsModel
...
@add_start_docstrings(
    ...
    :class:`~adj_tf.TFOpenAIGPTForSequenceClassification` uses the last token in order to do the classification,
