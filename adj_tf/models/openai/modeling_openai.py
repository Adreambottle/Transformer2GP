...
class OpenAIGPTDoubleHeadsModel(OpenAIGPTPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from adj_tf import OpenAIGPTTokenizer, OpenAIGPTDoubleHeadsModel
            >>> import torch
...
@add_start_docstrings(
    ...
    :class:`~adj_tf.OpenAIGPTForSequenceClassification` uses the last token in order to do the classification, as
