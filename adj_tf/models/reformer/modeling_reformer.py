...
class ReformerModelOutput(ModelOutput):
    """
    Output type of :class:`~adj_tf.ReformerModel`.
...
class ReformerModelWithLMHeadOutput(ModelOutput):
    """
    Output type of :class:`~adj_tf.ReformerModelWithLMHead`.
...
REFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adj_tf.ReformerConfig`): Model configuration class with all the parameters of the model.
...
REFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adj_tf.ReformerTokenizer`. See
        ...
        num_hashes (:obj:`int`, `optional`):
            ...
            For more information, see :obj:`num_hashes` in :class:`~adj_tf.ReformerConfig`.
