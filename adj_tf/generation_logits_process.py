...
class LogitsProcessorList(list):
    """
    This class can be used to create a list of :class:`~adj_tf.LogitsProcessor` or
    :class:`~adj_tf.LogitsWarper` to subsequently process a :obj:`scores` input tensor. This class inherits from
    list and adds a specific `__call__` method to apply each :class:`~adj_tf.LogitsProcessor` or
    :class:`~adj_tf.LogitsProcessor` to the inputs.
    """
...
class MinLengthLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adj_tf.LogitsProcessor` enforcing a min-length by setting EOS probability to 0.
...
class TemperatureLogitsWarper(LogitsWarper):
    r"""
    :class:`adj_tf.LogitsWarper` for temperature (exponential scaling output probability distribution).
...
class RepetitionPenaltyLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adj_tf.LogitsProcessor` enforcing an exponential penalty on repeated sequences.
...
class TopPLogitsWarper(LogitsWarper):
    """
    :class:`adj_tf.LogitsWarper` that performs top-p, i.e. restricting to top tokens summing to prob_cut_off <=
    prob_cut_off.
...
class TopKLogitsWarper(LogitsWarper):
    r"""
    :class:`adj_tf.LogitsWarper` that performs top-k, i.e. restricting to the k highest probability elements.
...
class NoRepeatNGramLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adj_tf.LogitsProcessor` that enforces no repetition of n-grams. See `Fairseq
...
class EncoderNoRepeatNGramLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adj_tf.LogitsProcessor` that enforces no repetition of encoder input ids n-grams for the decoder ids.
...
class NoBadWordsLogitsProcessor(LogitsProcessor):
    """
    :class:`adj_tf.LogitsProcessor` that enforces that specified sequences will never be sampled.
...
class PrefixConstrainedLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adj_tf.LogitsProcessor` that enforces contrained generation and is useful for prefix-conditioned
...
class HammingDiversityLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adj_tf.LogitsProcessor` that enforces diverse beam search. Note that this logits processor is only
    effective for :meth:`adj_tf.PretrainedModel.group_beam_search`. See `Diverse Beam Search: Decoding Diverse
...
class ForcedBOSTokenLogitsProcessor(LogitsProcessor):
    r"""
    :class:`~adj_tf.LogitsProcessor` that enforces the specified token as the first generated token.
...
class ForcedEOSTokenLogitsProcessor(LogitsProcessor):
    r"""
    :class:`~adj_tf.LogitsProcessor` that enforces the specified token as the last generated token when
