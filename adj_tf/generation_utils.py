...
class GenerationMixin:
    ...
    :class:`~adj_tf.PreTrainedModel`.
    """

    def prepare_inputs_for_generation(self, input_ids: torch.LongTensor, **kwargs) -> Dict[str, Any]:
        """
        Implement in subclasses of :class:`~adj_tf.PreTrainedModel` for custom behavior to prepare inputs in the
        generate method.
        """
    ...
    def adjust_logits_during_generation(self, logits: torch.FloatTensor, **kwargs) -> torch.FloatTensor:
        """
        Implement in subclasses of :class:`~adj_tf.PreTrainedModel` for custom behavior to adjust the logits in
        the generate method.
        """
        return logits
    ...
    def _get_logits_warper(
        ...
        """
        This class returns a :obj:`~adj_tf.LogitsProcessorList` list object that contains all relevant
        :obj:`~adj_tf.LogitsWarper` instances used for multinomial sampling.
        """
    ...
    def _get_logits_processor(
        ...
        """
        This class returns a :obj:`~adj_tf.LogitsProcessorList` list object that contains all relevant
        :obj:`~adj_tf.LogitsProcessor` instances used to modify the scores of the language model head.
        """
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        Examples::
            >>> from adj_tf import AutoTokenizer, AutoModelForCausalLM, AutoModelForSeq2SeqLM
