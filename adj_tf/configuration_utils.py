...
class PretrainedConfig(object):
    ...
    Class attributes (overridden by derived classes)
        ...
        - **model_type** (:obj:`str`): An identifier for the model type, serialized into the JSON file, and used to
          recreate the correct object in :class:`~adj_tf.AutoConfig`.
        - **is_composition** (:obj:`bool`): Whether the config class is composed of multiple sub-configs. In this case
          the config has to be initialized from two or more configs of type :class:`~adj_tf.PretrainedConfig`
          like: :class:`~adj_tf.EncoderDecoderConfig` or :class:`~RagConfig`.
    ...
    Args:
        name_or_path (:obj:`str`, `optional`, defaults to :obj:`""`):
            Store the string that was passed to :func:`~adj_tf.PreTrainedModel.from_pretrained` or
            :func:`~adj_tf.TFPreTrainedModel.from_pretrained` as ``pretrained_model_name_or_path`` if the
        ...
        return_dict (:obj:`bool`, `optional`, defaults to :obj:`True`):
            Whether or not the model should return a :class:`~adj_tf.file_utils.ModelOutput` instead of a plain
            tuple.
        ...
        add_cross_attention (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            that can be used as decoder models within the `:class:~adj_tf.EncoderDecoderModel` class, which
    ...
    Parameters for sequence generation
        ...
        - **return_dict_in_generate** (:obj:`bool`, `optional`, defaults to :obj:`False`) -- Whether the model should
          return a :class:`~adj_tf.file_utils.ModelOutput` instead of a :obj:`torch.LongTensor`
    ...
    def use_return_dict(self) -> bool:
        """
        :obj:`bool`: Whether or not return :class:`~adj_tf.file_utils.ModelOutput` instead of tuples.
        """
    ...
    def save_pretrained(self, save_directory: Union[str, os.PathLike]):
        ...
        :func:`~adj_tf.PretrainedConfig.from_pretrained` class method.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        r"""
        Instantiate a :class:`~adj_tf.PretrainedConfig` (or a derived class) from a pretrained model
        configuration.
        ...
        Args:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                ...
                - a path to a `directory` containing a configuration file saved using the
                  :func:`~adj_tf.PretrainedConfig.save_pretrained` method, e.g., ``./my_model_directory/``.
    ...
    def get_config_dict(
        ...
        :class:`~adj_tf.PretrainedConfig` using ``from_dict``.
    ...
    def from_dict(cls, config_dict: Dict[str, Any], **kwargs) -> "PretrainedConfig":
        """
        Instantiates a :class:`~adj_tf.PretrainedConfig` from a Python dictionary of parameters.

        Args:
            config_dict (:obj:`Dict[str, Any]`):
                Dictionary that will be used to instantiate the configuration object. Such a dictionary can be
                retrieved from a pretrained checkpoint by leveraging the
                :func:`~adj_tf.PretrainedConfig.get_config_dict` method.
    ...
    def from_json_file(cls, json_file: Union[str, os.PathLike]) -> "PretrainedConfig":
        """
        Instantiates a :class:`~adj_tf.PretrainedConfig` from the path to a JSON file of parameters.
