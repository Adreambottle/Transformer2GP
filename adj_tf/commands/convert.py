...
adj_tf can only be used from the commandline to convert TensorFlow models in PyTorch, In that case, it requires
...
class ConvertCommand(BaseTransformersCLICommand):
    ...
    def __init__(
        ...
        *args
        ...
        self._logger = logging.get_logger("adj_tf-cli/converting")
