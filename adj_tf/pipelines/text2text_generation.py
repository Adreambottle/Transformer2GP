...
class Text2TextGenerationPipeline(Pipeline):
    ...
    This Text2TextGenerationPipeline pipeline can currently be loaded from :func:`~adj_tf.pipeline` using the
...
class SummarizationPipeline(Text2TextGenerationPipeline):
    ...
    This summarizing pipeline can currently be loaded from :func:`~adj_tf.pipeline` using the following task
...
class TranslationPipeline(Text2TextGenerationPipeline):
    ...
    This translation pipeline can currently be loaded from :func:`~adj_tf.pipeline` using the following task
