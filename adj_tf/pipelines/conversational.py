...
class Conversation:
    ...
    :class:`~adj_tf.ConversationalPipeline`. The conversation contains a number of utility function to manage the
    addition of new user input and generated model responses. A conversation needs to contain an unprocessed user input
    before being passed to the :class:`~adj_tf.ConversationalPipeline`. This user input is either created when
    ...
    Arguments:
        text (:obj:`str`, `optional`):
            ...
            manually using the :meth:`~adj_tf.Conversation.add_user_input` method before the conversation can
            begin.
...
class ConversationalPipeline(Pipeline):
    ...
    This conversational pipeline can currently be loaded from :func:`~adj_tf.pipeline` using the following task
    ...
    def __call__(
        ...
        **generate_kwargs
        ...
        Args:
            conversations (a :class:`~adj_tf.Conversation` or a list of :class:`~adj_tf.Conversation`):
        ...
        Returns:
            :class:`~adj_tf.Conversation` or a list of :class:`~adj_tf.Conversation`: Conversation(s) with
