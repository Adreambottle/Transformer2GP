...
class QuestionAnsweringArgumentHandler(ArgumentHandler):
    ...
    internal :class:`~adj_tf.SquadExample`.

    QuestionAnsweringArgumentHandler manages all the possible to create a :class:`~adj_tf.SquadExample` from the
...
class QuestionAnsweringPipeline(Pipeline):
    ...
    This question answering pipeline can currently be loaded from :func:`~adj_tf.pipeline` using the following
    ...
    def create_sample(
        ...
        """
        QuestionAnsweringPipeline leverages the :class:`~adj_tf.SquadExample` internally. This helper method
        encapsulate all the logic for converting question(s) and context(s) to :class:`~adj_tf.SquadExample`.
        ...
        Returns:
            One or a list of :class:`~adj_tf.SquadExample`: The corresponding :class:`~adj_tf.SquadExample`
    ...
    def __call__(self, *args, **kwargs):
        ...
        Args:
            args (:class:`~adj_tf.SquadExample` or a list of :class:`~adj_tf.SquadExample`):
                One or several :class:`~adj_tf.SquadExample` containing the question and context.
            X (:class:`~adj_tf.SquadExample` or a list of :class:`~adj_tf.SquadExample`, `optional`):
                One or several :class:`~adj_tf.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).
            data (:class:`~adj_tf.SquadExample` or a list of :class:`~adj_tf.SquadExample`, `optional`):
                One or several :class:`~adj_tf.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).
