...
def get_framework(model, revision: Optional[str] = None):
    ...
    Args:
        model (:obj:`str`, :class:`~adj_tf.PreTrainedModel` or :class:`~adj_tf.TFPreTrainedModel`):
...
class PipelineException(Exception):
    """
    Raised by a :class:`~adj_tf.Pipeline` when handling __call__.
...
class ArgumentHandler(ABC):
    """
    Base interface for handling arguments for each :class:`~adj_tf.pipelines.Pipeline`.
    """
...
class PipelineDataFormat:
    ...
    def save(self, data: Union[dict, List[dict]]):
        ...
        :class:`~adj_tf.pipelines.PipelineDataFormat`.
    ...
    def from_str(
        ...
        """
        Creates an instance of the right subclass of :class:`~adj_tf.pipelines.PipelineDataFormat` depending on
        :obj:`format`.
...
PIPELINE_INIT_ARGS = r"""
    Arguments:
        model (:obj:`~adj_tf.PreTrainedModel` or :obj:`~adj_tf.TFPreTrainedModel`):
            The model that will be used by the pipeline to make predictions. This needs to be a model inheriting from
            :class:`~adj_tf.PreTrainedModel` for PyTorch and :class:`~adj_tf.TFPreTrainedModel` for
            TensorFlow.
        tokenizer (:obj:`~adj_tf.PreTrainedTokenizer`):
            The tokenizer that will be used by the pipeline to encode data for the model. This object inherits from
            :class:`~adj_tf.PreTrainedTokenizer`.
        modelcard (:obj:`str` or :class:`~adj_tf.ModelCard`, `optional`):
        ...
        args_parser (:class:`~adj_tf.pipelines.ArgumentHandler`, `optional`):
...
class Pipeline(_ScikitCompat):
    ...
    Some pipeline, like for instance :class:`~adj_tf.FeatureExtractionPipeline` (:obj:`'feature-extraction'` )
    ...
    def transform(self, X):
        """
        Scikit / Keras interface to adj_tf' pipelines. This method will forward to __call__().
        """
        return self(X=X)
