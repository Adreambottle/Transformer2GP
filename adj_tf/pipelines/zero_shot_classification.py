...
class ZeroShotClassificationPipeline(Pipeline):
    ...
    config's :attr:`~adj_tf.PretrainedConfig.label2id`.

    This NLI pipeline can currently be loaded from :func:`~adj_tf.pipeline` using the following task identifier:
    ...
    def __call__(
        ...
        """
        Classify the sequence(s) given as inputs. See the :obj:`~adj_tf.ZeroShotClassificationPipeline`
