...
class FlaxPreTrainedModel(ABC):
    ...
    :class:`~adj_tf.FlaxPreTrainedModel` takes care of storing the configuration of the models and handles
    ...
    def from_pretrained(
        ...
        **kwargs
        ...
        Examples::
            ...
            >>> from adj_tf import BertConfig, FlaxBertModel
    ...
    def save_pretrained(self, save_directory: Union[str, os.PathLike]):
        ...
        `:func:`~adj_tf.FlaxPreTrainedModel.from_pretrained`` class method
