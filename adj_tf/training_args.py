...
class TrainingArguments:
    ...
    Using :class:`~adj_tf.HfArgumentParser` we can turn this class into `argparse
    ...
    Parameters:
        ...
        do_train (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether to run training or not. This argument is not directly used by :class:`~adj_tf.Trainer`, it's
        ...
        do_eval (:obj:`bool`, `optional`):
            ...
            :class:`~adj_tf.Trainer`, it's intended to be used by your training/evaluation scripts instead. See
        ...
        do_predict (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            the `example scripts <https://github.com/huggingface/transformers/tree/master/examples>`__ for more
            details.
        evaluation_strategy (:obj:`str` or :class:`~adj_tf.trainer_utils.EvaluationStrategy`, `optional`, defaults to :obj:`"no"`):
        ...
        learning_rate (:obj:`float`, `optional`, defaults to 5e-5):
            The initial learning rate for :class:`~adj_tf.AdamW` optimizer.
        weight_decay (:obj:`float`, `optional`, defaults to 0):
            The weight decay to apply (if not zero) to all layers except all bias and LayerNorm weights in
            :class:`~adj_tf.AdamW` optimizer.
        adam_beta1 (:obj:`float`, `optional`, defaults to 0.9):
            The beta1 hyperparameter for the :class:`~adj_tf.AdamW` optimizer.
        adam_beta2 (:obj:`float`, `optional`, defaults to 0.999):
            The beta2 hyperparameter for the :class:`~adj_tf.AdamW` optimizer.
        adam_epsilon (:obj:`float`, `optional`, defaults to 1e-8):
            The epsilon hyperparameter for the :class:`~adj_tf.AdamW` optimizer.
        ...
        lr_scheduler_type (:obj:`str` or :class:`~adj_tf.SchedulerType`, `optional`, defaults to :obj:`"linear"`):
            The scheduler type to use. See the documentation of :class:`~adj_tf.SchedulerType` for all possible
            values.
        ...
        logging_strategy (:obj:`str` or :class:`~adj_tf.trainer_utils.LoggingStrategy`, `optional`, defaults to :obj:`"steps"`):
        ...
        seed (:obj:`int`, `optional`, defaults to 42):
            ...
            :func:`~adj_tf.Trainer.model_init` function to instantiate the model if it has some randomly
        ...
        disable_tqdm (:obj:`bool`, `optional`):
            ...
            :class:`~adj_tf.notebook.NotebookTrainingTracker` in Jupyter Notebooks. Will default to :obj:`True`
        ...
        remove_unused_columns (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            (Note that this behavior is not implemented for :class:`~adj_tf.TFTrainer` yet.)
        ...
        adafactor (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not to use the :class:`~adj_tf.Adafactor` optimizer instead of
            :class:`~adj_tf.AdamW`.
