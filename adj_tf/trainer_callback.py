...
class TrainerState:
    """
    A class containing the :class:`~adj_tf.Trainer` inner state that will be saved along the model and optimizer
    when checkpointing and passed to the :class:`~adj_tf.TrainerCallback`.
...
class TrainerControl:
    """
    A class that handles the :class:`~adj_tf.Trainer` control flow. This class is used by the
    :class:`~adj_tf.TrainerCallback` to activate some switches in the training loop.
...
class TrainerCallback:
    ...
    Args:
        args (:class:`~transformers.TrainingArguments`):
            The training arguments used to instantiate the :class:`~adj_tf.Trainer`.
        state (:class:`~transformers.TrainerState`):
            The current state of the :class:`~adj_tf.Trainer`.
        control (:class:`~transformers.TrainerControl`):
            The object that is returned to the :class:`~adj_tf.Trainer` and can be used to make some decisions.
        model (:class:`~adj_tf.PreTrainedModel` or :obj:`torch.nn.Module`):
    ...
    def on_init_end(self, args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the end of the initialization of the :class:`~adj_tf.Trainer`.
        """
        pass
...
class DefaultFlowCallback(TrainerCallback):
    """
    A :class:`~adj_tf.TrainerCallback` that handles the default flow of the training loop for logs, evaluation
    and checkpoints.
    """
...
class ProgressCallback(TrainerCallback):
    """
    A :class:`~adj_tf.TrainerCallback` that displays the progress of training or evaluation.
    """
...
class PrinterCallback(TrainerCallback):
    """
    A bare :class:`~adj_tf.TrainerCallback` that just prints the logs.
    """
...
class EarlyStoppingCallback(TrainerCallback):
    """
    A :class:`~adj_tf.TrainerCallback` that handles early stopping.
    ...
    This callback depends on :class:`~adj_tf.TrainingArguments` argument `load_best_model_at_end` functionality
    to set best_metric in :class:`~adj_tf.TrainerState`.
    """
