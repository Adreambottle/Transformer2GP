...
class TFPreTrainedModel(tf.keras.Model, TFModelUtilsMixin, TFGenerationMixin):
    ...
    :class:`~adj_tf.TFPreTrainedModel` takes care of storing the configuration of the models and handles methods
    ...
    def serving_output(output):
        ...
        Args:
            output (:obj:`~adj_tf.TFBaseModelOutput`):
    ...
    def save_pretrained(self, save_directory, saved_model=False, version=1):
        ...
        :func:`~adj_tf.TFPreTrainedModel.from_pretrained` class method.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            >>> from adj_tf import BertConfig, TFBertModel
